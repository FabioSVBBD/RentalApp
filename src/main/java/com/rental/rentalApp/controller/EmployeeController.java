...
public class EmployeeController {
	...
	@GetMapping("")
  public ResponseEntity<Iterable<Employee>> getAllEmployees( @RequestParam(required = false) String name, @RequestParam(required = false) String surname,
    @RequestParam(required = false)  @DateTimeFormat(pattern="yyyy-MM-dd") LocalDate dateOfEmployment, @RequestParam(required = false) String number) {
  ...
  @GetMapping("/since")
  public ResponseEntity<Iterable<Employee>> insertEmployee(@RequestParam("date") @DateTimeFormat(pattern="yyyy-MM-dd") LocalDate dateOfEmployment ) {
  ...
  @PatchMapping("")
  public ResponseEntity<String> updateEmployee(@RequestParam("date") @DateTimeFormat(pattern="yyyy-MM-dd") LocalDate startDate, @RequestParam() Integer id,  @RequestBody Employee updateEmployee ) {
